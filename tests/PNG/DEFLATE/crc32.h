...
unsigned crc32_slow(unsigned char* data, int length)
{
	// slow because it calculates the table from the polynomial every time
	static unsigned* crcTable;
	unsigned crc; //32 bit unsigned data
	unsigned poly = 0xEDB88320; //polynomial
//	unsigned poly = 0x04C11DB7; //polynomial msbit-first (normal)
